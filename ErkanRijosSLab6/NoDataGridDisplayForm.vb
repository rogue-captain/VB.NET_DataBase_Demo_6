...
Imports System.IO
Public Class NoDataGridDisplayForm
    ...
    Private Sub NoDataGridDisplayForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dataGridViewBtn_Click(sender As Object, e As EventArgs) Handles dataGridViewBtn.Click
    ...
    Private Sub addSingleRecordBtn_Click(sender As Object, e As EventArgs) Handles addSingleRecordBtn.Click
        ...
        If openFileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Try
                ...
                For Each line As String In entireRecord
                    ...
                    ' Split the line using a comma as delimiter
                    Dim parts As String() = line.Split(New Char() {" "c, ControlChars.Tab}, StringSplitOptions.RemoveEmptyEntries)
